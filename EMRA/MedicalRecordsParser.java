...
public class MedicalRecordsParser {
	...
	private static boolean updateMedicalRecordbyInputLine(MedicalRecord medicalRecord,
	...
	public static ArrayList<MedicalRecord> parse(File inputFile) {
